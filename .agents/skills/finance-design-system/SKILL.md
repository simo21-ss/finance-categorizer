...
description: Maintain design consistency when updating the finance-categorizer frontend UI. Use this skill when the user asks to create, modify, or refactor frontend components, pages, or styles. Ensures all components follow the standardized design system with proper CSS classes, BEM naming conventions, and component patterns.
license: Complete terms in LICENSE.txt
---

# Finance Categorizer Design System

This skill ensures consistency across the finance-categorizer frontend by enforcing a standardized component library and design patterns.
